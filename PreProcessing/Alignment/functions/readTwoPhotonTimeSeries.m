function imageArray = readTwoPhotonTimeSeries(filename, imagingInfo, serieNum)
    ...
    % series to the desired series, i.e., serieNum = 1.
    reader.setSeries(serieNum - 1); % We need 0-based index.
